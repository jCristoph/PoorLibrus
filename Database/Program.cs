...
namespace Baza_Danych
{
    class Program
    {
        ...
        {
            Base b = new Base();
            Veryfication ver = new Veryfication(b, "", "");
            ...
            string answear = ver.veryficate() ? "Dobry login i hasło" : "Zły login lub hasło";
            Console.Out.WriteLine(answear);

            ver.Login = "n90001";
            answear = ver.veryficate() ? "Dobry login i hasło" : "Zły login lub hasło";
            Console.Out.WriteLine(answear);

            ver.Pass = "Nauczyciel1";
            answear = ver.veryficate() ? "Dobry login i hasło" : "Zły login lub hasło";
            Console.Out.WriteLine(answear);
        }
    }
